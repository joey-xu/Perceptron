...
p2 = [1 1]';
t2 = 1;
[w1,b1] = lms_sub(w,b,p1,t1,p2,t2,alpha);
subplot(3,3,1);
plot_line(w1,b1);
plot(p1(1),p1(2),'rx');
plot(p2(1),p2(2),'bx');
...
p2 = [0.5 0.5]';
t2 = 1;
[w2,b2] = lms_sub(w,b,p1,t1,p2,t2,alpha);
subplot(3,3,4);
plot_line(w2,b2);
plot(p1(1),p1(2),'rx');
plot(p2(1),p2(2),'bx');
...
p2 = [1 1]';
t2 = 1;
[w3,b3] = lms_sub(w,b,p1,t1,p2,t2,alpha);
subplot(3,3,2);
plot_line(w3,b3);
plot(p1(1),p1(2),'rx');
plot(p2(1),p2(2),'bx');
...
p2 = [0.5 0.5]';
t2 = 1;
[w4,b4] = lms_sub(w,b,p1,t1,p2,t2,alpha);
subplot(3,3,5);
plot_line(w4,b4);
plot(p1(1),p1(2),'rx');
plot(p2(1),p2(2),'bx');
...
p2 = [1 1]';
t2 = 1;
[w5,b5] = lms_sub(w,b,p1,t1,p2,t2,alpha);
subplot(3,3,3);
plot_line(w5,b5);
plot(p1(1),p1(2),'rx');
plot(p2(1),p2(2),'bx');
...
p2 = [0.5 0.5]';
t2 = 1;
[w6,b6] = lms_sub(w,b,p1,t1,p2,t2,alpha);
subplot(3,3,6);
plot_line(w6,b6);
plot(p1(1),p1(2),'rx');
plot(p2(1),p2(2),'bx');
...
plot([0 0 1],[0 1 0],'rx');
plot([0.5 1],[0.5 1],'bx');
title('max( min(1,2), min(3,4), min(5,6) )');
